...
//     'REQUIRE_AUTH_ACTION'       => '',        // 默认需要认证操作
    ...
    'ERROR_PAGE'=>'/index.php/Mobile/Public/tp404.html',
    // 表单令牌验证相关的配置参数
    ...
    // 订单用户端显示状态
    'WAITPAY'=>' AND pay_status = 0 AND order_status = 0', //订单查询状态 待支付
    'WAITSEND'=>' AND pay_status=1 AND shipping_status !=1 AND order_status in(0,1) ', //订单查询状态 待发货
