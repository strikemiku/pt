        ...
        <form action="<?php echo U('Mobile/User/add_address');?>" method="post" onSubmit="return checkForm()">
            <ul>
                ...
                <li>
                    ...
                    <select class="province_select"  name="province" id="province" onChange="get_city(this)" style="width: 20%;padding-right: 1px;">
                    ...
                    <select name="city" id="city" onChange="get_area(this)" style="width: 20%;padding-right: 1px;">
                        <option  value="0">请选择</option>
                    ...
                    <select name="district" id="district" onChange="get_twon(this)" style="width: 20%;padding-right: 1px;">
                        <option  value="0">请选择</option>
                    ...
                    <!--<?php if(is_array($twon)): $i = 0; $__LIST__ = $twon;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>-->
            ...
            <div class="dotm_btn">
                ...
                <?php if($_GET['source'] == null): ?><!--如果是下订单时提交过了的页面-->
                    ...
                    <?php if($_GET[maichu_id] != null): ?><input type="hidden" name="maichu_id" value="<?php echo ($_GET[maichu_id]); ?>" /><?php endif; endif; ?>
