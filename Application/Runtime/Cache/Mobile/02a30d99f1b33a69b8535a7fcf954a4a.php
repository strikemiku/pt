...
<meta name="Generator" content="TPSHOP v1.1" />
  ...
  <link rel="stylesheet" href="/Template/mobile/wuyang/Static/old/css/loginxin.css">
...
<div class="ng-form-zhu" style="text-align: center;font-size:16px;">
  <div class="tips_a">
      ...
      <img src="/Template/mobile/wuyang/Static/old/images/xin/icogantanhao.png"></div>
     <?php }else{ ?>
     <img src="/Template/mobile/wuyang/Static/old/images/xin/icogantanhao-sb.png"></div>
     <?php }?>
  <div class="tips">
