                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                            ...
                            <button type="button" onclick="location.href='<?php echo U('Admin/goods/addEditfxGoods');?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加新商品</button>
                        </form>
                    </div>
...
<script>
    ...
    function ajax_get_table(form,page){
        ...
        $.ajax({
            type : "POST",
            url:"/index.php?m=Admin&c=goods&a=ajaxfxList&p="+page,//+tab,
    ...
    function del(id)
    {
        layer.confirm('确定要删除吗?',{icon:3,btn:['确定','取消']},function(index){
