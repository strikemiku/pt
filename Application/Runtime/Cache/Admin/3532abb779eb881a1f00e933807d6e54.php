            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form id="search-form2" class="navbar-form form-inline"  method="post" action="/Admin/User/withdrawals">
                            <div class="form-group">
                                <label class="control-label">提现用户:</label>
                                <div class="input-group">
                                    <input type="text" style="width: 130px;" class="form-control" id="nickname" name="nickname"  placeholder="提现用户名" value="<?php echo ($_REQUEST['nickname']); ?>" />
                                </div>
                                ...
                                <div class="form-group">
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="1" <?php if($_REQUEST['status'] == 1): ?>selected<?php endif; ?>>已成功</option>
                                        <option value="2" <?php if($_REQUEST['status'] == 2): ?>selected<?php endif; ?>>已拒绝</option>
                                    </select>
                                </div>
                                <!--<label  class="control-label">提现类型:</label>-->
                                <!--<div class="form-group">-->
                                    <!--<select class="form-control" id="tx_type" name="tx_type">-->
                                        <!--<option value="">-提现类型-</option>-->
                                        <!--<option value="1" <?php if($_REQUEST['tx_type'] == 1): ?>selected<?php endif; ?>>余额</option>-->
                                        <!--<option value="2" <?php if($_REQUEST['tx_type'] == 2): ?>selected<?php endif; ?>>奖金</option>-->
                                    <!--</select>-->
                                <!--</div>-->
                                <label  class="control-label">提现类型:</label>
                                <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <!--<th class="sorting text-left">提现类型</th>-->
                                    <th class="sorting text-center">提现金额</th>
                                    <th class="sorting text-center">手续费</th>
                                    <th class="sorting text-center">扣除金额</th>
                                    <th class="sorting text-center">收款方式</th>
                                    <th class="sorting text-center">收款信息</th>
                                    <!--<th class="sorting text-center">提现账号</th>-->
                                    <!--<th class="sorting text-center">银行名称</th>-->
                                    <!--<th class="sorting text-center">开户行</th>-->
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <!--<td class="text-left">-->
                                            <!--<?php if($v["tx_type"] == 1): ?>-->
                                                <!--余额-->
                                                <!--<?php elseif($v["tx_type"] == 2): ?>-->
                                                <!--奖金-->
                                            <!--<?php endif; ?>-->
                                        <!--</td>-->
                                        <td class="text-center"><?php echo ($v["money"]); ?></td>
                                        <td class="text-center"><?php echo ($v["feiyong"]); ?></td>
                                        <td class="text-center"><?php echo ($v["last_money"]); ?></td>
                                        <td class="text-center">
                                            <?php if($v["type"] == 1): ?>支付宝
                                                <?php elseif($v["type"] == 2): ?>
                                                微信
                                        ...
                                        <td class="text-center">
                                            <?php if($v["type"] != 3): ?><a href="javascript:void(0);" onclick="show('<?php echo ($v["account_bank"]); ?>')">
                                                    查看
                                                </a>
                                                <?php else: ?>
                                                <a href="javascript:void(0);" onclick='show_bank("<?php echo ($v["account_name"]); ?>","<?php echo ($v["bank_name"]); ?>","<?php echo ($v["bank_kai"]); ?>","<?php echo ($v["account_bank"]); ?>")'>
                                                    查看
                                                </a><?php endif; ?>
                                        </td>
                                        <script>
...
//
                                        ...
                                        <!--<td class="text-center"><?php echo ($v["account_bank"]); ?></td>-->
                                        <!--<td class="text-center"><?php echo ($v["bank_name"]); ?></td>-->
                                        <!--<td class="text-center"><?php echo ($v["account_name"]); ?></td>-->
                                        <td class="text-center">
                                            <?php if($v[status] == 0): ?><span style="color: orange">待审核</span><?php endif; ?>
                                            <?php if($v[status] == 1): ?><span style="color: green">已成功</span><?php endif; ?>
                                            <?php if($v[status] == 2): ?><span style="color: red">已拒绝</span><?php endif; ?>
                                        </td>
                                        <td class="text-center"><?php echo ((isset($v["remark"]) && ($v["remark"] !== ""))?($v["remark"]):""); ?></td>
                                        <td class="text-center"><?php echo (date("Y-m-d H:i",$v["create_time"])); ?></td>
                                        <td class="text-center">
                                            <a href="javascript:void(0);" class="btn btn-primary" data-url="" onclick="shen(<?php echo ($v["id"]); ?>,<?php echo ($v["status"]); ?>)"> 审核</a>
