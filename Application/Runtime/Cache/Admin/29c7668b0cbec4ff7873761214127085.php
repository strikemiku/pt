            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form id="search-form2" class="navbar-form form-inline"  method="get" action="<?php echo U('/Admin/User/active_log');?>">
                            <div class="form-group">
                                <label for="input-order-id" class="control-label">类型:</label>
                                <select class="form-control" id="type" name="type">
                                    <option value="">请选择类型</option>
                                    <option value="1"<?php if($_REQUEST['type'] == '1'): ?>selected<?php endif; ?>>签到</option>
                                    <option value="2"<?php if($_REQUEST['type'] == '2'): ?>selected<?php endif; ?>>漏签</option>
                                    <option value="3"<?php if($_REQUEST['type'] == '3'): ?>selected<?php endif; ?>>抽奖</option>
                                </select>
