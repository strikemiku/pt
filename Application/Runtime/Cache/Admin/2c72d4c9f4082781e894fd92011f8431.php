        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i>互转记录</h3>
                </div>
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form id="search-form2" class="navbar-form form-inline"  method="post" action="<?php echo U('/Admin/User/hz_log');?>">
                            <div class="form-group">
                                <label for="input-order-id" class="control-label">会员姓名:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="nickname" placeholder="会员姓名" value="<?php echo ($_REQUEST['nickname']); ?>" name="nickname" />
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting text-left">转出姓名</th>
                                    <th class="sorting text-left">转出账号</th>
                                    <th class="sorting text-left">转账金额</th>
                                    <th class="sorting text-left">手续费</th>
                                    <th class="sorting text-left">转入姓名</th>
                                    <th class="sorting text-left">转入账号</th>
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-left"><?php echo ($v["to_user_name"]); ?></td>
                                        <td class="text-left"><?php echo ($v["to_mobile"]); ?></td>
