                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="javascript:sort('order_sn');">商品名称</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="javascript:sort('order_sn');">下单用户</a>
                                    </td>
                                    <td class="text-center">
                                ...
                                <?php if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center"><?php echo (getSubstr($list["goods_name"],0,10)); ?></td>
                                        ...
                                        <td class="text-center"><?php echo ($list["invoice_no"]); ?></td>
