        ...
        <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i>积分记录</h3>
                </div>
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form id="search-form2" class="navbar-form form-inline"  method="get" action="<?php echo U('/Admin/User/jifen_log');?>">
                            <div class="form-group">
                                <label for="input-order-id" class="control-label">类型:</label>
                                <select class="form-control" id="type" name="type">
                                    <option value="">请选择类型</option>
                                    <option value="1"<?php if($_REQUEST['type'] == '1'): ?>selected<?php endif; ?>>转出</option>
                                    <option value="2"<?php if($_REQUEST['type'] == '2'): ?>selected<?php endif; ?>>系统充值</option>
                                    <option value="3"<?php if($_REQUEST['type'] == '3'): ?>selected<?php endif; ?>>转入</option>
                                    <option value="4"<?php if($_REQUEST['type'] == '4'): ?>selected<?php endif; ?>>兑换积分</option>
                                    <option value="5"<?php if($_REQUEST['type'] == '5'): ?>selected<?php endif; ?>>拼团失败</option>
                                    <option value="6"<?php if($_REQUEST['type'] == '6'): ?>selected<?php endif; ?>>积分支付</option>
                                    <option value="7"<?php if($_REQUEST['type'] == '7'): ?>selected<?php endif; ?>>开通会员</option>
                                </select>
                                <label for="input-order-id" class="control-label">会员昵称:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="nickname" placeholder="会员昵称" value="<?php echo ($_REQUEST['nickname']); ?>" name="nickname" />
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting text-left">积分</th>
