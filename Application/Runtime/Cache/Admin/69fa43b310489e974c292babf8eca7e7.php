		...
		<div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
                    <span class="info-box-icon bg-aqua"><i class="fa fa-bell"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text">今日新增订单</span>
                        <span class="info-box-number"><?php echo ($count["new_order"]); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
			...
			<div class="col-md-12">
		      <div class="box box-info">
		        <div class="box-header">
		          <h3 class="box-title">今日拼团统计</h3>
		        </div>
		        <div class="box-body">
	         		<div class="row">
			  			<div class="col-sm-2 col-xs-6">
			  				拼团总数：<?php echo ($count["total_pt_num"]); ?>
			  			</div>
			  				<div class="col-sm-2 col-xs-6">
			  				拼团中：<?php echo ($count["do_pt_num"]); ?>
			  			</div>
			  				<div class="col-sm-2 col-xs-6">
			  				拼团成功：<?php echo ($count["win_pt_num"]); ?>
			  			</div>
			  			<div class="col-sm-2 col-xs-6">
			  				未成团：<?php echo ($count["no_pt_num"]); ?>
			  			</div>
                        <div class="col-sm-2 col-xs-6">
                            拼团失败：<?php echo ($count["false_pt_num"]); ?>
                        </div>
		  			</div>
		        </div>
		      </div>
