        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-list"></i> 添加成团人数</h3>
                </div>
                <div class="panel-body ">
                    <!--表单数据-->
                    <form method="post" id="handleposition" action="<?php echo U('Admin/Promotion/numHandle');?>">
                        <!--通用信息-->
                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-sm-4">请填写数量</td>
                                    </tr>
                                    <tr>
                                        <td>中奖人数：</td>
                                        <td>
                                            <input type="text" class="form-control" name="award_bl" value="<?php echo ($info["award_bl"]); ?>" >
                                        </td>
                                        <td class="col-sm-4">人</td>
                                    </tr>
                                    <tr>
                                        <td>红包奖励比例：</td>
                                        <td>
                                            <input type="text" class="form-control" name="hb_bl" value="<?php echo ($info["hb_bl"]); ?>" >
                                        </td>
                                        <td class="col-sm-4">%，未中奖得红包奖励比例</td>
                                    </tr>
                                    <tr>
                                        <td>显示：</td>
                                        <td >
