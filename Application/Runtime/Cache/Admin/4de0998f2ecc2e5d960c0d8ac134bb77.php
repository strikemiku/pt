                ...
                <div class="panel-body">
                    ...
                    <form method="post" id="addEditGoodsForm">
                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>商品简介:</td>
                                        <td>
                                            <textarea rows="3" cols="70" name="goods_remark"><?php echo ($goodsInfo["goods_remark"]); ?></textarea>
                                    ...
                                    <!--<tr>-->
                                        ...
                                        <!--<td>-->
                                            <!--<div class="col-xs-2">-->
                                                <!--<select name="cat_id" id="cat_id" onchange="get_category(this.value,'cat_id_2','0');" class="form-control" style="width:200px;margin-left:-15px;">-->
                                            ...
                                            <!--</div>-->
                                            <!--<div class="col-xs-2">-->
                                                <!--<select name="cat_id_2" id="cat_id_2" onchange="get_category(this.value,'cat_id_3','0');" class="form-control" style="width:200px;margin-left:-15px;">-->
                                                    <!--<option value="0">选择商品分类</option>-->
                                                <!--</select>-->
                                            <!--</div>-->
                                    ...
                                    <tr>
                                        <td>出售价:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($goodsInfo["shop_price"]); ?>" name="shop_price" id="shop_price"  class="form-control" style="width:180px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                    ...
                                    <tr>
                                        <td>市场价:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($goodsInfo["market_price"]); ?>" name="market_price"  class="form-control" style="width:180px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                    ...
                                    <!--<tr>-->
                                        <!--<td>积分抵扣比例:</td>-->
                                        <!--<td>-->
                                            <!--<input type="text" value="<?php echo ($goodsInfo["jifen_bl"]); ?>" name="jifen_bl"  class="form-control" style="width:180px;" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />-->
                                            <!--<span id="err_market_price" style="color:#F00;">%</span>-->
                                        <!--</td>-->
                                    <!--</tr>-->
                                    <!--<tr>-->
                                        <!--<td>邮费:</td>-->
                                    ...
                                    <tr>
                                        <td>库存数量:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($goodsInfo["store_count"]); ?>" class="form-control" style="width:180px;" name="store_count" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                    ...
                                    <tr>
                                        <td>商品排序:</td>
                                        <td>
                                            <input type="text" value="<?php echo ($goodsInfo["sort"]); ?>" class="form-control" style="width:180px;" name="sort" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
                                            <span id="err_sort" style="color:#F00; ">排序越小越靠前</span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="pull-left" style="margin-left: 17%;">
                            ...
                            <button class="btn btn-primary" onclick="ajax_submit_form('addEditGoodsForm','<?php echo U('Goods/addEditfxGoods?is_ajax=1');?>');" title="" data-toggle="tooltip" type="button" data-original-title="保存">保存</button>
                        </div>
                    </form><!--表单数据-->
                </div>
            </div>
