                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                	<td class="text-left"><?php echo ($list["order_id"]); ?></td>
                                    <td class="text-left"><?php echo ($list["nickname"]); ?></td>
                                    <td class="text-left"><?php echo ($list["order_sn"]); ?></td>
                                    <td class="text-left"><?php echo ($list["level_name"]); ?></td>
                                    <!--<td class="text-left"><?php echo ($list["show_account"]); ?></td>-->
                                    <td class="text-left"><?php echo ($list["account"]); ?></td>
                                    <td class="text-left"><?php echo (date("Y-m-d",$list["add_time"])); ?></td>
                                    <td class="text-left"><?php echo (date("Y-m-d",$list["end_time"])); ?></td>
                                    <td class="text-left"><?php echo ($list["pay_name"]); ?></td>
                                    <td class="text-left">
                                        <?php if($list[pay_status] == 0): ?><span style="color: orangered">未支付</span>
                                            <?php else: ?>
                                            <span style="color: green">已支付</span><?php endif; ?>
                                    </td>
                                    <td class="text-left"><?php echo (date("Y-m-d H:i",(isset($list["pay_time"]) && ($list["pay_time"] !== ""))?($list["pay_time"]):"---")); ?></td>
