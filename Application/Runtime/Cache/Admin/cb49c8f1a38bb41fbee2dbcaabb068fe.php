						...
						<div class="row">
							<div class="col-sm-12">
								<table id="list-table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
									<thead>
									<tr role="row">
										<th class="sorting" tabindex="0" style="text-align: center">等级</th>
										<th class="sorting" tabindex="0" style="text-align: center">等级名称</th>
										<th class="sorting" tabindex="0" style="text-align: center">金额</th>
										<th class="sorting" tabindex="0" style="text-align: center">拼团次数</th>
                                        <th class="sorting" tabindex="0" style="text-align: center">周期</th>
									...
									<?php if(is_array($list)): foreach($list as $k=>$vo): ?><tr role="row" align="center">
											...
											<td>
                                                <?php if($vo['level'] > 1): echo ($vo["money"]); ?>
                                                    <?php else: ?>
                                                    ---<?php endif; ?>
											</td>
											<td>
												<?php echo ($vo["pt_num"]); ?>次
											</td>
                                            <td>
                                                <?php if($vo['level'] > 1): echo ($vo["days"]); ?>天
                                                    <?php else: ?>
                                                    ---<?php endif; ?>
                                            </td>
											<td>
												<a class="btn btn-primary" href="<?php echo U('User/level',array('act'=>'edit','level_id'=>$vo['level_id']));?>">编辑</a>
