...
!function (window) {
 ...
 $(document).ready(function(){
        $(".xiannav_con li").click(function(){
        $(".xiannav_con li").eq($(this).index()).addClass("active").siblings().removeClass("active");
		$(".xiangcon_list").hide().eq($(this).index()).show();
        });
    });
 $(document).ready(function(){
        $(".aui-scroll-item").click(function(){
        $(".aui-scroll-item").eq($(this).index()).addClass("aui-crt").siblings().removeClass("aui-crt");
		$(".aui-scroll-content-item").hide().eq($(this).index()).show();
        });
    });
